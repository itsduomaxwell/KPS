...
kps.rotations.register("PRIEST","HOLY",{
    ...
    {{"nested"}, 'kps.interrupt' ,{
        {spells.guardianSpirit, 'mouseover.immuneHeal and mouseover.hp < 0.30 ' , "mouseover" },
    ...
    {spells.holyWordSerenity, 'focus.isFriend and focus.hp < 0.40' , "focus"},
    ...
    {{spells.prayerOfMending,spells.divineHymn}, 'not player.isMoving and spells.prayerOfMending.cooldown == 0 and keys.alt' ,  kps.heal.aggroTankTarget },
    {spells.divineHymn, 'not player.isMoving and heal.hasBuffStacks(spells.prayerOfMending) > 5 and keys.alt' ,  kps.heal.aggroTankTarget }, 
    -- "Prayer of Mending" (Tank only)
    {spells.prayerOfMending, 'not player.isMoving and heal.hasBuffStacks(spells.prayerOfMending) < 10 and not heal.lowestTankInRaid.hasBuff(spells.prayerOfMending)' , kps.heal.lowestTankInRaid },
    {spells.prayerOfMending, 'not player.isMoving and heal.hasBuffStacks(spells.prayerOfMending) < 10 and not heal.aggroTankTarget.hasBuff(spells.prayerOfMending)' , kps.heal.aggroTankTarget},
    {spells.prayerOfMending, 'not player.isMoving and heal.hasBuffStacks(spells.prayerOfMending) < 10 and not heal.lowestInRaid.hasBuff(spells.prayerOfMending)' , kps.heal.lowestInRaid},
    ...
    {{spells.lightOfTuure,spells.flashHeal}, 'not player.isMoving and spells.lightOfTuure.cooldown == 0 and heal.lowestInRaid.hp < 0.55 and not heal.lowestInRaid.hasBuff(spells.lightOfTuure)' , kps.heal.lowestInRaid},
    {spells.flashHeal, 'not player.isMoving and spells.prayerOfMending.lastCasted(4) and heal.lowestInRaid.hp < 0.40' , kps.heal.lowestInRaid ,"FLASH_LOWEST_POMlastCasted" },

    -- "Soins de lien" 32546 -- kps.lastCast["name"] ne fonctionne pas si lastcast etait une macro 'kps.lastCast["name"] == spells.prayerOfHealing'
    {{"nested"}, 'spells.prayerOfHealing.lastCasted(4)' , {
    ...
    {{spells.holyWordSanctify,spells.flashHeal,spells.prayerOfHealing}, 'not player.isMoving and spells.holyWordSanctify.cooldown == 0 and heal.countLossInRange(0.62) >= 3' , kps.heal.lowestInRaid  },
    {{spells.flashHeal,spells.prayerOfHealing}, 'not player.isMoving and player.hasBuff(spells.powerOfTheNaaru) and heal.countLossInRange(0.62) >= 3' , kps.heal.lowestInRaid  , "POH_BUFF" },
        
    {{spells.holyWordSanctify,spells.flashHeal,spells.prayerOfHealing}, ' not player.isMoving and spells.holyWordSanctify.cooldown == 0 and heal.countLossInRange(0.78) >= 4 and heal.lowestInRaid.hp < 0.55' , kps.heal.lowestInRaid  },
    {{spells.holyWordSanctify,spells.bindingHeal,spells.prayerOfHealing}, 'not player.isMoving and spells.holyWordSanctify.cooldown == 0 and heal.countLossInRange(0.78) >= 4' , kps.heal.lowestInRaid  },
    {{spells.flashHeal,spells.prayerOfHealing}, 'not player.isMoving and player.hasBuff(spells.powerOfTheNaaru) and heal.countLossInRange(0.78) >= 4 and heal.lowestInRaid.hp < 0.55' , kps.heal.lowestInRaid  , "POH_BUFF" },
    {{spells.bindingHeal,spells.prayerOfHealing}, 'not player.isMoving and player.hasBuff(spells.powerOfTheNaaru) and heal.countLossInRange(0.78) >= 4' , kps.heal.lowestInRaid  , "POH_BUFF" },
    {{spells.bindingHeal,spells.prayerOfHealing}, 'not player.isMoving and heal.countLossInRange(0.78) >= 4 and not spells.prayerOfHealing.isRecastAt(heal.lowestInRaid.unit)', kps.heal.lowestInRaid , "POH_COUNT" },
    ...
    {{"nested"}, 'not player.isMoving and heal.countLossInRange(0.82) >= 3 and not player.isInRaid' ,{
        ...
        {{spells.holyWordSanctify,spells.bindingHeal,spells.prayerOfHealing}, 'spells.holyWordSanctify.cooldown == 0' , kps.heal.lowestInRaid  },
        ...
        {{spells.bindingHeal,spells.prayerOfHealing}, 'player.hasBuff(spells.powerOfTheNaaru)' , kps.heal.lowestInRaid , "POH_BUFF" },
        {{spells.bindingHeal,spells.prayerOfHealing}, 'not spells.prayerOfHealing.isRecastAt(heal.lowestInRaid.unit)' , kps.heal.lowestInRaid , "POH_COUNT" },
    }},
    ...
    -- ABSOPTION HEAL
    {{"nested"}, 'mouseover.absorptionHeal' , {
        {spells.renew, 'not mouseover.hasBuff(spells.renew)' , "mouseover" , "ABSORB_HEAL" },
        {spells.holyWordSerenity, 'mouseover.hp < < 0.55' , "mouseover" , "ABSORB_HEAL" },
        {spells.flashHeal, 'not player.isMoving and mouseover.hp < 0.70' , "mouseover" , "ABSORB_HEAL" },
        {spells.bindingHeal, 'not player.isMoving and not mouseover.isUnit("player") and mouseover.hp < 0.90' , "mouseover" },
        {spells.heal, 'not player.isMoving and mouseover.hp < 1' , "mouseover" , "ABSORB_HEAL" },
    }},
    -- MOUSEOVER
    {{"nested"}, 'kps.defensive and mouseover.isFriend' , {
        ...
        {spells.heal, 'mouseover.hp < 0.80' , "mouseover" },
        {spells.bindingHeal, 'not player.isMoving and not mouseover.isUnit("player") and mouseover.hp < 0.90' , "mouseover" },
        {spells.heal, 'mouseover.hp < 1' , "mouseover" },
    }},

    -- DAMAGE
    {{"nested"}, 'kps.multiTarget and heal.lowestInRaid.hp > target.hp and heal.lowestInRaid.hp > 0.78' , {
    ...
    -- "Soins rapides" 2060
    {spells.flashHeal, 'not player.isMoving and heal.lowestTankInRaid.hp < 0.55 and (heal.lowestTankInRaid.incomingDamage - heal.lowestTankInRaid.incomingHeal) > 0' , kps.heal.lowestTankInRaid , "FLASH_TANK_DMG" },
    {spells.flashHeal, 'not player.isMoving and heal.aggroTankTarget.hp < 0.55 and (heal.aggroTankTarget.incomingDamage - heal.aggroTankTarget.incomingHeal) > 0' , kps.heal.aggroTankTarget , "FLASH_AGGRO_DMG" },
    {spells.flashHeal, 'not player.isMoving and heal.lowestInRaid.hp < 0.40 and (heal.lowestInRaid.incomingDamage - heal.lowestInRaid.incomingHeal) > 0' , kps.heal.lowestInRaid , "FLASH_LOWEST_DMG" },
    ...
    -- "Soins de lien" 32546
    {spells.bindingHeal, 'not player.isMoving and player.hp < 0.90 and not heal.lowestInRaid.isUnit("player")' , kps.heal.lowestInRaid ,"BINDING_PLAYER" },
    ...
    {spells.renew, 'player.isMoving and heal.lowestInRaid.hp < threshold() and not heal.lowestInRaid.hasBuff(spells.renew) and not heal.lowestInRaid.hasBuff(spells.masteryEchoOfLight)' , kps.heal.lowestInRaid, "RENEW" },
    ...
    {spells.holyNova, 'player.isMoving and targettarget.distance < 10 and targettarget.isAttackable and heal.countLossInDistance(0.90,10) >= 3' , "targettarget" },
    {spells.holyNova, 'player.isMoving and focustarget.distance < 10 and focustarget.isAttackable and heal.countLossInDistance(0.90,10) >= 3' , "focustarget" },
